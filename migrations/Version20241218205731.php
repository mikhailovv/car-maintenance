...
final class Version20241218205731 extends AbstractMigration
{
    ...
    {
        $this->addSql("CREATE TYPE purchase_type AS ENUM ('service', 'part', 'oil')");
        $this->addSql('CREATE TABLE purchases (id UUID NOT NULL, user_id UUID DEFAULT NULL, quantity DOUBLE PRECISION NOT NULL, purchase_type purchase_type NOT NULL, unit_price_amount NUMERIC(33, 18) NOT NULL, unit_price_currency_code VARCHAR(3) NOT NULL, total_price_amount NUMERIC(33, 18) NOT NULL, total_price_currency_code VARCHAR(3) NOT NULL, PRIMARY KEY(id))');
        $this->addSql('CREATE INDEX IDX_USER_ID ON purchases (user_id)');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('DROP TYPE purchase_type');
    }
}
